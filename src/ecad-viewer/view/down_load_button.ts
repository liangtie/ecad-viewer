import { css } from "../../base/web-components/css";
import { attribute, query } from "../../base/web-components/decorators";
import { html } from "../../base/web-components/html";
import { KCUIElement } from "../../kc-ui/element";

export class DownloadButton extends KCUIElement {
...
window.customElements.define("ecad-download-button", DownloadButton);
