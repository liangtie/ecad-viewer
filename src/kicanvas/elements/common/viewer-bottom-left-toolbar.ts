...
export class KCViewerBottomToolbarLeftElement extends KCUIElement {
    ...
    override render() {
        ...
        return html`<kc-ui-floating-toolbar-left location="bottom">
            ${this.#zoom_out} ${this.#reset} ${this.#zoom_in}
        </kc-ui-floating-toolbar-left>`;
    }
}

window.customElements.define(
    "kc-viewer-bottom-toolbar-left",
